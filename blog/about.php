            ...
            <div id="nav-aside">
                ...
                <div class="section-row">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="assets/webmag/img/widget-2.jpg"
                                alt=""></a>
                        <div class="post-body">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="assets/webmag/img/widget-3.jpg"
                                alt=""></a>
                        <div class="post-body">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="blog-post.html"><img src="assets/webmag/img/widget-4.jpg"
                                alt=""></a>
                        <div class="post-body">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="section-row">
                        ...
                        <figure class="figure-img">
                            <img class="img-responsive" src="assets/webmag/img/about-1.jpg" alt="">
                        </figure>
                    ...
                    <div class="row section-row">
                        <div class="col-md-6">
                            <figure class="figure-img">
                                <img class="img-responsive" src="assets/webmag/img/about-2.jpg" alt="">
                            </figure>
                        </div>
                        <div class="col-md-6">
                            <h3>Our Mission</h3>
                ...
                <div class="col-md-4">
                    ...
                    <div class="aside-widget">
                        ...
                        <div class="post post-widget">
                            <a class="post-img" href="blog-post.html"><img src="assets/webmag/img/widget-1.jpg"
                                    alt=""></a>
                            <div class="post-body">
                                <h3 class="post-title"><a href="blog-post.html">Tell-A-Tool: Guide To Web Design And
                                        Development Tools</a></h3>
