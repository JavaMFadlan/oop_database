...
<body>
    ...
    <header id="header">
        ...
        <div id="post-header" class="page-header">
            <div class="background-img" style="background-image: url('assets/webmag/img/post-page.jpg');"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        <div class="post-meta">
                ...
                <div class="col-md-8">
                    <div class="section-row sticky-container">
                        <div class="main-post">
                            ...
                            <figure class="figure-img">
                                <img class="img-responsive" src="assets/webmag/img/post-4.jpg" alt="">
                    ...
                    <div class="section-row text-center">
                        <a href="#" style="display: inline-block;margin: auto;">
                            <img class="img-responsive" src="assets/webmag/img/ad-2.jpg" alt="">
                        </a>
                    </div>
                    <!-- ad -->
                        ...
                        <div class="post-author">
                            <div class="media">
                                <div class="media-left">
                                    <img class="media-object" src="assets/webmag/img/author.png" alt="">
                                </div>
                    ...
                    <div class="section-row">
                        ...
                        <div class="post-comments">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <img class="media-object" src="assets/webmag/img/avatar.png" alt="">
                                </div>
                                <div class="media-body">
                                    <div class="media-heading">
                                        <h4>John Doe</h4>
